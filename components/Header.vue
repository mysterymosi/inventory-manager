    ...
    <div class="container">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
        ...
        <ul class="navbar-nav" v-else>
          <li class="nav-item">
            <span style="margin-right: 10px;">{{ profile.firstName }} {{ profile.lastName }}</span>
          </li>
          <li class="nav-item">
            <!-- <button class="nav-link" @click="logout"><i class="fa fa-sign-in"></i> Logout</button> -->
            <AppButton style="color: white;" class="nav-link" @click="logout">
