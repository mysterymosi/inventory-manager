    ...
    <div>
            ...
            <div class="col-lg-3 col-md-6    col-sm-6 col-xs-12">
                <div class="white-box">
                    ...
                    <div class="text-right"> <span class="text-muted">Todays Income</span>
                        <h1><sup><i class="ti-arrow-up text-success"></i></sup>{{ dailySum[date] }}</h1> </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="white-box">
                    ...
                    <div class="text-right"> <span class="text-muted">Weekly Income</span>
                        <h1><sup><i class="ti-arrow-down text-danger"></i></sup> {{ weeklySum[date] }}</h1> </div> 
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-6 col-xs-12">
                <div class="white-box">
                    ...
                    <div class="text-right"> <span class="text-muted">Monthly Income</span>
                        <h1><sup><i class="ti-arrow-up text-info"></i></sup> {{ monthlySum[date] }}</h1> </div> 
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6    col-sm-6 col-xs-12">
                <div class="white-box">
                    <h3 class="box-title">Daily Sales</h3>
                    <div class="text-right"> <span class="text-muted">Todays Expenses</span>
                        <h1><sup><i class="ti-arrow-up text-success"></i></sup> 3000 </h1> </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="white-box">
                    <h3 class="box-title">Weekly Sales</h3>
                    <div class="text-right"> <span class="text-muted">Weekly Expenses</span>
                        <h1><sup><i class="ti-arrow-down text-danger"></i></sup>30000 </h1> </div> 
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-6 col-xs-12">
                <div class="white-box">
                    <h3 class="box-title">Monthly Sales</h3>
                    <div class="text-right"> <span class="text-muted">Monthly Expenses</span>
                        <h1><sup><i class="ti-arrow-up text-info"></i></sup> 300000</h1> </div> 
                </div>
            </div>
    ...
    methods: {
        endWeekIncome () {
            ...
            if (this.counter % 4 == 0) {
                ...
                console.log("monthly sum from admin says: ", this.monthlySum[this.date])
            }
